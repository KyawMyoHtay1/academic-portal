...
<section class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="aspect-video w-full overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                <img src="{{ asset('images/news/opportunities.jpg') }}" alt="Student Opportunities" class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                <div class="hidden h-full w-full items-center justify-center bg-gradient-to-br from-emerald-100/40 to-slate-200">
                    <span class="text-slate-400 text-sm font-medium">Add: images/news/opportunities.jpg</span>
                </div>
            </div>
            <div class="p-5 border-t border-slate-100">
        ...
        <div class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="aspect-video w-full overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                <img src="{{ asset('images/news/community_stories.jpg') }}" alt="Community Stories" class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                <div class="hidden h-full w-full items-center justify-center bg-gradient-to-br from-sky-100/40 to-slate-200">
                    <span class="text-slate-400 text-sm font-medium">Add: images/news/community_stories.jpg</span>
                </div>
            </div>
            <div class="p-5 border-t border-slate-100">
