<section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
    <div class="flex flex-wrap items-center justify-center gap-4 md:gap-8">
        ...
        <a href="{{ route('guest.about') }}" class="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50/50 px-5 py-3 text-slate-700 hover:border-[color:var(--portal-navy)] hover:bg-[color:var(--portal-navy)]/5 hover:text-[color:var(--portal-navy)] transition-all">
            <span class="flex h-10 w-10 items-center justify-center rounded-lg bg-[color:var(--portal-gold)]/20 text-[color:var(--portal-navy)]">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ asset('docs/University_Academic_Portal_User_Manual.pdf') }}" target="_blank" rel="noopener" class="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50/50 px-5 py-3 text-slate-700 hover:border-[color:var(--portal-navy)] hover:bg-[color:var(--portal-navy)]/5 hover:text-[color:var(--portal-navy)] transition-all">
            <span class="flex h-10 w-10 items-center justify-center rounded-lg bg-[color:var(--portal-navy)]/10 text-[color:var(--portal-navy)]">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span class="font-semibold">User Manual</span>
        </a>
