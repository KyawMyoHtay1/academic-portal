    ...
    <section class="relative overflow-hidden rounded-3xl shadow-2xl ring-1 ring-slate-900/20">
        ...
        <div class="relative z-10 px-6 py-10 md:px-10 md:py-14">
            ...
            <div class="mt-10 grid grid-cols-2 gap-6 border-t border-white/25 pt-8 md:grid-cols-4">
                ...
                <div class="text-center">
                    <p class="text-5xl font-bold leading-none text-white">{{ number_format($stats['totalCredits'] ?? 0) }}</p>
                    <p class="mt-3 text-lg font-semibold text-slate-100">Credits Available</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="flex items-end justify-between gap-4 pt-2">
                            ...
                            <div class="grid min-w-0 gap-1 text-right text-sm">
                                ...
                                <span class="inline-flex items-center justify-end gap-1 text-slate-500">
                                    ...
                                    {{ $story->created_at?->format('M d, Y') ?? now()->format('M d, Y') }}
                                </span>
                            </div>
                        </div>
                    </div>
