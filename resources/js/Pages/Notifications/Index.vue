    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                <!-- Header Banner -->
                <div class="mb-6 overflow-hidden rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-white shadow-lg">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold">Notifications Center</h3>
                            <p class="mt-1 text-sm text-white/90">Stay informed about grades, fees, timetable and attendance updates</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="portal-card overflow-hidden">
                    ...
                    <ul v-else class="divide-y divide-slate-100">
                        <li
                            ...
                            :class="notification.read_at ? 'bg-white hover:bg-slate-50' : 'bg-portal-sky/5 hover:bg-portal-sky/10'"
                        >
                            <!-- Icon -->
                            <div class="mt-1 flex-shrink-0">
                                <div
                                    ...
                                    :class="{
                                        'bg-emerald-100': notification.type === 'grade',
                                        'bg-blue-100': notification.type === 'fee',
                                        'bg-indigo-100': notification.type === 'timetable',
                                        'bg-amber-100': notification.type === 'attendance',
                                        'bg-slate-100': !['grade', 'fee', 'timetable', 'attendance'].includes(notification.type),
                                    }"
                                >
                                    <svg
                                    ...
                                    <svg
                                        v-else-if="notification.type === 'timetable'"
                                    ...
                                    <svg
                                        v-else-if="notification.type === 'attendance'"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-4">
                                    ...
                                    <p class="flex-shrink-0 whitespace-nowrap text-xs text-slate-500">
