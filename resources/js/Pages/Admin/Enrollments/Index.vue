...
const hasReviewActions = (status) =>
    status === "pending" || status === "withdrawal_pending";
</script>
                ...
                >
                    ...
                    >
                        ...
                        <div class="space-y-4 text-sm">
                            ...
                            <div
                                v-if="hasReviewActions(quickViewEnrollment.status)"
                            ...
                            >
                                ...
                                <div class="mt-3 flex flex-wrap gap-2">
                                    <template
                                        v-if="quickViewEnrollment.status === 'pending'"
                                    >
                                        <button
                                            type="button"
                                            class="rounded-md bg-emerald-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                                            @click="
                                                approveEnrollment(
                                                    quickViewEnrollment.enrollment_id
                                                )
                                            "
                                        >
                                            Approve Enrollment
                                        ...
                                        <button
                                            type="button"
                                            class="rounded-md bg-red-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                                            @click="
                                                rejectEnrollment(
                                                    quickViewEnrollment.enrollment_id
                                                )
