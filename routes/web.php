...
Route::get('/guest/user-manual', [GuestPageController::class, 'userManualView'])->name('guest.user-manual.view');
Route::get('/guest/user-manual/download', [GuestPageController::class, 'userManualDownload'])->name('guest.user-manual.download');
Route::get('/', [GuestPageController::class, 'home'])->name('guest.home');
Route::get('/guest/courses', [GuestPageController::class, 'courses'])->name('guest.courses');
Route::get('/guest/courses/{course}', [GuestPageController::class, 'showCourse'])->whereNumber('course')->name('guest.courses.show');
Route::get('/guest/news', [GuestPageController::class, 'news'])->name('guest.news');
Route::get('/guest/news/{announcement}', [GuestPageController::class, 'showNews'])->whereNumber('announcement')->name('guest.news.show');
Route::get('/guest/about', [GuestPageController::class, 'about'])->name('guest.about');
Route::get('/guest/vision', [GuestPageController::class, 'vision'])->name('guest.vision');
Route::get('/guest/services', [GuestPageController::class, 'services'])->name('guest.services');
Route::get('/guest/support', [GuestPageController::class, 'support'])->name('guest.support');
Route::get('/guest/contact', [GuestPageController::class, 'contact'])->name('guest.contact');
...
Route::get('/privacy-policy', [GuestPageController::class, 'privacyPolicy'])->name('privacy-policy');
Route::get('/terms-and-conditions', [GuestPageController::class, 'termsAndConditions'])->name('terms-and-conditions');
